...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String FUSIONNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, FUSIONNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, FUSIONNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(FUSIONNS, "interval");
            if(newInterval != null)
